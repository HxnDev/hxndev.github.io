import{c as j,r as s,u as v,g as l,j as e,B as g,C as u,T as c,a as w,G as y,b as f,d as b,I as k,e as S,R as F,L as C,f as z}from"./index-BYhyNVPk.js";import{G as p,A as R}from"./AnimatedSection-B1E187EP.js";import{u as E,E as N}from"./useGetProjects-ur8lOvCd.js";import{S as B}from"./SponsorshipSection-CaQsB9OS.js";import{S as I}from"./SimpleGrid-uUShpqO8.js";import"./Badge-B_O2WL5J.js";import"./projects-BDOO29ja.js";/**
 ...
 */var Y=j("outline","download","IconDownload",[["path",{d:"M4 17v2a2 2 0 0 0 2 2h12a2 2 0 0 0 2 -2v-2",key:"svg-0"}],["path",{d:"M7 11l5 5l5 -5",key:"svg-1"}],["path",{d:"M12 4l0 12",key:"svg-2"}]]);const D=()=>{const x=s.useRef(null),t=s.useRef(null),i=s.useRef(null),m=s.useRef(null),{colorScheme:h}=v(),a=h==="dark";return s.useEffect(()=>{if(!t.current||!i.current)return;l.set(t.current.querySelectorAll(".animate-item"),{y:50,opacity:0}),l.set(i.current,{scale:.8,opacity:0,rotationY:-15});const n=l.timeline({defaults:{duration:.8,ease:"power3.out"}});n.to(t.current.querySelectorAll(".animate-item"),{y:0,opacity:1,stagger:.2}),n.to(i.current,{scale:1,opacity:1,rotationY:0,duration:1.2},"-=0.5");const d=()=>{const o=window.scrollY*.15;l.to(i.current,{y:-o*.5,duration:.1}),l.to(t.current,{y:o*.3,duration:.1})};return window.addEventListener("scroll",d),()=>{window.removeEventListener("scroll",d)}},[]),e.jsxs(g,{ref:x,style:{position:"relative",padding:"80px 0 100px",overflow:"hidden",background:a?"radial-gradient(circle at 30% 50%, rgba(155, 0, 255, 0.15), transparent 70%)":"radial-gradient(circle at 30% 50%, rgba(155, 0, 255, 0.05), transparent 70%)"},children:[e.jsx("div",{className:"orb orb-1"}),e.jsx("div",{className:"orb orb-2"}),e.jsx("div",{className:"orb orb-3"}),e.jsx(u,{size:"lg",children:e.jsxs(p,{gutter:60,children:[e.jsxs(p.Col,{md:7,ref:t,children:[e.jsx(g,{className:"animate-item",mb:20,children:e.jsx(c,{component:"span",size:"lg",style:{background:"linear-gradient(45deg, #00F5FF, #9B00FF)",WebkitBackgroundClip:"text",WebkitTextFillColor:"transparent",fontWeight:700},children:"Full Stack Developer & ML Engineer"})}),e.jsx(w,{className:"animate-item",style:{fontSize:"4rem",fontWeight:900,lineHeight:1.1,backgroundImage:"linear-gradient(45deg, #6200EE, #03DAC5)",backgroundClip:"text",WebkitBackgroundClip:"text",WebkitTextFillColor:"transparent",marginBottom:"1.5rem"},children:"Hi, I'm Hassan Shahzad"}),e.jsx(c,{className:"animate-item",size:"xl",color:a?"dimmed":"dark",style:{maxWidth:"600px",lineHeight:1.6,marginBottom:"2rem"},children:"Specializing in creating intelligent, intuitive applications that solve real-world problems with a passion for clean code and innovative solutions."}),e.jsxs(y,{position:"left",spacing:"md",className:"animate-item",ref:m,children:[e.jsx(f,{component:"a",href:b("assets/resume/hassan_resume.pdf"),size:"lg",leftSection:e.jsx(Y,{size:20}),radius:"xl",style:{background:"linear-gradient(45deg, #6200EE, #9B00FF)",boxShadow:"0 4px 15px rgba(155, 0, 255, 0.3)",transition:"all 0.3s ease"},sx:{"&:hover":{transform:"translateY(-3px)",boxShadow:"0 8px 20px rgba(155, 0, 255, 0.4)"}},download:"hassan_resume.pdf",children:"Download Resume"}),e.jsx(f,{component:"a",href:"https://github.com/HxnDev",target:"_blank",size:"lg",variant:a?"outline":"filled",leftSection:e.jsx(k,{size:20}),rightSection:e.jsx(W,{size:16}),radius:"xl",style:{borderColor:"#9B00FF",color:a?"#00F5FF":"white",backgroundColor:a?"transparent":"#9B00FF",transition:"all 0.3s ease"},sx:{"&:hover":{transform:"translateY(-3px)",background:a?"rgba(155, 0, 255, 0.1)":"#8100d9",boxShadow:"0 8px 20px rgba(0, 0, 0, 0.1)"}},children:"GitHub Profile"})]})]}),e.jsx(p.Col,{md:5,style:{position:"relative"},children:e.jsxs("div",{className:"profile-container",ref:i,children:[e.jsx("div",{className:"profile-image-wrapper",children:e.jsx("img",{src:b("images/profile.jpg"),alt:"Hassan Shahzad",className:"profile-image"})}),e.jsx("div",{className:"glow-effect"}),e.jsx("div",{className:"circle-decoration circle-1"}),e.jsx("div",{className:"circle-decoration circle-2"})]})})]})}),e.jsx("style",{children:`
      ...
      `})]})};export{X as default};
//# sourceMappingURL=Home-DJ_1iRES.js.map

...
const BiographySection = ({ bio, image }) => {
  ...
  const { reducedMotion, scrollPosition } = useAnimationContext();
      ...
      {!reducedMotion && (
        <Box
          style={{
            ...
            height: 300,
            borderRadius: '50%',
            background: 'radial-gradient(circle at center, rgba(155, 0, 255, 0.15), transparent 70%)',
            filter: 'blur(40px)',
            zIndex: 0
          }}
        />
                ...
                <>
                  ...
                  <Box
                    style={{
                      ...
                      height: 100,
                      borderRadius: '50%',
                      background: 'radial-gradient(circle at center, rgba(155, 0, 255, 0.3), transparent 70%)',
                      filter: 'blur(20px)',
                      zIndex: -1
                    }}
                  />

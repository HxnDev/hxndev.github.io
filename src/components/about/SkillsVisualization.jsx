...
import { Paper, Title, Text, Group, Tabs, Box, Badge, Progress, Grid, ThemeIcon, Button } from '@mantine/core';
import { gsap } from 'gsap';
import { useColorScheme } from '../../theme/ThemeProvider';
import { useAnimationContext } from '../../context/AnimationContext';
import { IconBrandJavascript, IconBrandPython, IconBrandReact, IconDatabase, IconServer, IconCloud, IconTools, IconBrandGit } from '@tabler/icons-react';
...
const SkillsVisualization = ({ skills = [] }) => {
  ...
  return (
    <Paper withBorder p="xl" radius="md">
      <Title order={2} mb="lg">Skills & Expertise</Title>

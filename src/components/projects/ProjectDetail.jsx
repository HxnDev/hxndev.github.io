  ...
  return (
    <Container size="lg" ref={containerRef}>
      ...
      >
        ...
        <Box>
          <Title className="animate-in" order={2} mb="md">Overview</Title>
          ...
          {project.features && (
            <>
              <Title className="animate-in" order={3} mb="md">Key Features</Title>
              <List
                spacing="sm"
                mb="xl"
                center
        ...
        <Box>
          <Title className="animate-in" order={2} mb="md">Technical Details</Title>
          
          {project.technicalDetails ? (
            <>
              <Text className="animate-in" mb="lg">
                {project.technicalDetails.description || "Technical information about this project."}
              </Text>
              
              {project.technicalDetails.architecture && (
                <>
                  <Title className="animate-in" order={3} mb="md">Architecture</Title>
                  <Text className="animate-in" mb="xl">
                    {project.technicalDetails.architecture}
                  </Text>
                </>
              ...
              {project.technicalDetails.challenges && (
                <>
                  <Title className="animate-in" order={3} mb="md">Challenges & Solutions</Title>
                  <List spacing="sm" mb="xl">
                    {project.technicalDetails.challenges.map((challenge, index) => (
                      <List.Item key={index} className="animate-in" sx={{ animationDelay: `${0.2 + (index * 0.1)}s` }}>
          ...
          <Title className="animate-in" order={3} mb="md">Technologies</Title>
      ...
      {hasScreenshots && (
        <Container size="lg" mt="xl">
          <Divider my="xl" className="animate-in" />
          <Title className="animate-in" order={2} mb="xl">Screenshots</Title>
